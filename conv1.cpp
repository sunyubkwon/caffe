...
void conv_cal(int c,int c_cols,int c_rows,int d,int cha,int f_size,int s,Mat result,int ***pad,int **f,int ***rr,int sum)
{	
	clock_t begin=clock();	
	for(int k=0;k<cha;k++)
		{
